...
ps_service:
		...
		// Byte 1 
		ldi		temp0, 0x82				; (0x41) digital pad
		rcall	psx_io
		rcall	psx_ack					// ACK byte 0 
		...
		rcall	psx_io
		rcall	psx_ack					// ACK byte 1 

		// Byte 3 
		mov		temp0, psx0				; data byte 0
		rcall	swapbits
		rcall	psx_io_wait				; wait for byte 2 to finish
		rcall	psx_io
		rcall	psx_ack					// ACK byte 2 

		// Byte 4 
		mov		temp0, psx1				; data byte 1
		rcall	swapbits
		rcall	psx_io_wait				; wait for byte 3 to finish
		rcall	psx_io
		rcall	psx_ack					// ACK byte 3 
		rcall	psx_io_wait
