...
ps_wait_att:
		...
		rcall	psx_io
		rcall	psx_sat1_read			; read saturn
		rcall	psx_sat2_setup			; prepare for next read
		rcall	psx_io_wait				; wait for PSX IO to finish
		...
		rcall	psx_io
		rcall	psx_ack					; ACK for byte 0, need to have started IO by this point
										; as there is not enough time to start it after returning
										; from the ACK
		rcall	psx_sat2_read
		rcall	psx_sat4_setup
		rcall	psx_io_wait
