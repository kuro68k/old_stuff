...
psx_sat3:
		...
		; Start button
		;sbrc	psx0, 3				; if Start held
		;rjmp	psx_sat00_nostartremap
		;sbrc	temp2, SAT_RT		; and R held
		;rjmp	psx_sat00_nostartremap
		;ori		temp2, SAT_RT		; unpress R
		;ori		psx0, (1<<3)		; unmap start
		;andi	psx0, ~(1<<0)		; map to select
;psx_sat00_nostartremap:
