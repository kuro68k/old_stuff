...
ps:
		...
		; PD7 low for ease of jumpering with PB0
		ldi		temp0, (1<<SAT_TH)|(1<<SAT_TR)|(1<<SEG_OE)|(1<<7)
		out		DDRD, temp0
		; TH=1, TR=0, PD7=0, rest pull-ups
		ldi		temp0, ~((1<<SAT_TR)|(1<<SEG_OE)|(1<<7))
		out		PORTD, temp0

		; PORTB setup
		; PB0 PS2 Saturn pad emulation jumper
		in		temp0, PORTB
		ori		temp0, (1<<0)
		out		PORTB, temp0
		in		temp0, DDRB
...
ps_loop:
		; Check PS2 Saturn pad emulation mode
		in		temp0, PORTB
		sbrc	temp0, 0
		rjmp	ps_wait_ack
		ldi		temp0, 2				; PS2 Saturn pad button mapping
