...
ps_io_fail_timeout:
		...
		; reset start held count if in PS2 Saturn pad emulation mode
		;tst		emumode
		;brne	ps_not_emu_mode
		sbis	PINB, 0
		rjmp	ps_loop
...
ps_tmode:
		...
		sbr		psx0, (1<<0)			; clear select button
...
psx_sat01_start_abc:
		clr		startf
		sbrc	bmap, TMODE			; disabled in tournament mode
		rjmp	psx_sat01_done
