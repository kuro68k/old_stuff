...
.def	startf			= R3	; flag for start held
.def	afbutton		= R4	; flag for autofire button on/off
;.def	automap			= R5	; autofire button map
...
reset:
		...
		; PORTC setup. See table above
		ldi		temp0, 0b00111111		; all outputs for SG
		out		PORTC, temp0
		ldi		temp0, 0b00111111
		out		DDRC, temp0

		ldi		temp0, 0b11111111		; all outputs for SG except SG_LF/J1/SEG_LAT
		andi	temp0, ~(1<<SEG_LAT)
		out		PORTB, temp0
		ldi		temp0, ~((1<<J1)|(1<<SAT_LF)|(1<<SEG_LAT))
		out		DDRB, temp0
